<?php include_once('sg-page-open.php'); ?>
...
<div class="sg-about sg-section">
  ...
  <p>If you are looking for resources on style guides, check out <a href="http://styleguides.io">styleguides.io</a>. There are a ton of great articles, books, podcasts, talks, and other style guide tools!</p>
	<p>Where applicable, you can view the source HTML by clicking the &ldquo;View Source&rdquo; button below each component.</p>
</div><!--/.sg-about-->



<?php include('sg-colors.php'); ?>
<?php include('sg-fonts.php'); ?>


<?php include_once('sg-page-close.php'); ?>
